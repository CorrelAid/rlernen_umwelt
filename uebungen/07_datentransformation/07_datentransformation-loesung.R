...
# Um sinnvoll mit unserem Daten arbeiten zu können, müssen wir diese zunächst einmal mithilfe der `dplyr`-Verben bereinigen - dabei gehen wir Schritt für Schritt für.

### Übung 3.1: Daten filtern ---------------------------------------------------
# Zuerst filtern wir die Daten nach folgenden Bedingungen...: 
...
# Dazu müssen wir mithilfe der `mutate()`-Funktion die Ländervariable `country` bearbeiten. Ergänzt den Code an der entsprechenden Stellen, die durch ??? gekennzeichnet sind.
