...
Die **Stiftung Datenschutz** kennen wir ja bereits! Diese haben, wie wir finden, eine ziemlich hilfreiche **Vorlage für Vereine und gemeinnützige Organisationen** veröffentlicht. Dieses Muster wollen wir mit Euch teilen - Ihr könnt es [hier](https://github.com/CorrelAid/lernplattform/blob/main/abbildungen/02_datenschutz-und-datenethik/MusterDatenverarbeitungsverzeichnis.xlsx?raw=true){target="_blank"} herunterladen.
