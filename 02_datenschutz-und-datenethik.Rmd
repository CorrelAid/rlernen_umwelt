...
Die Verarbeitung von personenbezogenen Daten unterliegt dem sogenannten **Verbotsprinzip**: Nur wenn Ihr eine explizite Berechtigung zur Datenverarbeitung habt, dürft Ihr dies auch tun. Eine jursitische Erlaubnis zur Verarbeitung der Daten wird durch folgende **Erlaubnistatbestände** gesichert:
...
Auf Grund Eurer **Informationspflichten** (Art. 12-14 DSGVO) müsst Ihr bei der Datenerfassung auf **Rechtsgrundlage, Zweck, Speicherdauer, Kontaktdaten der Verantwortlichen, die Weitergabe an Dritte und Rechte der Betroffenen** aufmerksam machen.
...
Da der **Datenschutz in anderen Ländern** (z.B. in den USA) nicht so ausgeprägt ist wie in der EU, solltet Ihr bei der Auswahl von datenverarbeitenden Tools darauf achten, wo sie ihren Hauptsitz und Server haben. Möglicherweise müsst Ihr dann zusätzliche Maßnahmen zum Schutz der Daten ergreifen (z.B. rechtliche Vereinbarung, Passwortschutz, Verschlüsselung).
Am besten veröffentlicht Ihr auf Eurer Webseite Eure **Datenschutzerklärung sowie Kontaktdaten von Ansprechpartner:innen** und legt mit klar definierten Verantwortlichen ein **Verarbeitungsverzeichnis und Datenschutzmanagementsystem** an, welches Ihr in festen Abständen regelmäßig **überprüft**. Eine vollständige Datenschutzerklärung enthält idealerweise folgende Dinge:
...
quiz(caption = NULL,
  question("Weil Ihr den morgendlichen und bitter benötigten Kaffee über Euren Arbeitslaptop verschüttet, verliert Ihr die Mitgliedsdaten Eures 20 Mitglieder starken Vereins, die Ihr lokal in einer Excel-Datei gespeichert hattet. Die Daten sind unwiderruflich verschwunden. „Kein Problem“, denkt Ihr, „für von Kaffee eliminierte Daten bin ich ja nicht haftungspflichtig.“ Ist das richtig?",
      answer("Ja"),
      answer("Nein", correct = TRUE),
      correct = "Richtig! Die Datenpanne (Art. 4 DSGVO) könnt, müsst Ihr aber nicht unbedingt innerhalb von 72h der zuständigen Behörde melden, da das Risiko für Betroffene hier nicht sehr groß ist. Den Vorfall sowie Eure Überlegungen zur Meldepflicht solltet Ihr trotzdem dokumentieren.",
...
quiz(caption = NULL,
  question("Wie könnt Ihr Daten zu Geschlecht und Aussehen sensibel erheben?",
      ...
      answer("Mit Selbstidentifikation mit einigen Vorschlägen, Opt Out und Freitextfeld sowie Fremdidentifikation (d.h. wie andere Menschen die Befragungsperson wahrnehmen würden)", correct = TRUE),
      correct = "Richtig!",
