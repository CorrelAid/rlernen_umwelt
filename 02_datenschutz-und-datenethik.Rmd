...
Das **Recht auf informationelle Selbstbestimmung** ist Teil des verfassungsrechtlich verankerten **allgemeinen Persönlichkeitsrechts**  (Art. 1 Abs. 1 und Art. 2 Abs. 1 GG) und sichert "das Recht des Einzelnen, grundsätzlich selbst über die Preisgabe und Verwendung seiner personenbezogenen Daten zu bestimmen" ([s. Bundesministerium des Innern und für Heimat](https://www.bmi.bund.de/DE/themen/verfassung/datenschutz/datenschutz-node.html){target="_blank"}). Wichtige Rechtsgrundlage dafür ist die **Europäische Datenschutzgrundverordnung (kurz: DSGVO)**, welche am 25. Mai 2018 in Kraft getreten ist. Neben den 99 Artikeln, enthält diese zusätzlich insgesamt 173 sogenannte **Erwägungsgründe**, also Zusätze, die eine wichtige Rolle im Verständnis und der Anwendung der Gesetze spielen. Sie sorgen dafür, dass Kontextmerkmale berücksichtigt oder komplexe Bestimmungen und ihre Hintergründe erläutert werden. Einen Überblick über alle Erwägungsgründe findet ihr [hier] (https://dsgvo-gesetz.de/erwaegungsgruende/){target="_blank"}.
...
quiz(caption = NULL,
  question("Welche Daten werden von der DSGVO geschützt?",
    ...
    answer("Alle Daten"),
    correct = "Richtig! Die DSGVO schützt ausschließlich personenbezogene Daten. Daten von jursitischen, also nicht-natürlichen Personen, (z.B. von Vereinen und Unternehmen) sind daher nicht von der DSGVO geschützt. Hier gelten ggf. das Geschäftsgeheimnisgesetz (GeschGehG) oder bilateral getroffene Vereinbarungen zur Datenverarbeitung.",
    incorrect = "Leider falsch. Richtig wäre: Die DSGVO schützt nämlich ausschließlich personenbezogene Daten. Daten von juristischen, also nicht-natürlichen Personen, (z.B. von Vereinen und Unternehmen) sind daher nicht von der DSGVO. Hier gelten ggf. das Geschäftsgeheimnisgesetz (GeschGehG) oder bilateral getroffene Vereinbarungen zur Datenverarbeitung.",
    allow_retry = TRUE,
...
Folgt man **Art. 4 DSGVO**, so werden Personenbezogene Daten als "alle Informationen, mit denen natürliche Personen, also Menschen, direkt oder indirekt **identifiziert** werden können" definiert. 
...
quiz(caption = NULL,
  question("Wie lange dürfen Daten gespeichert werden?",
      ...
      correct = "Richtig! Grundsätzlich gilt bei Erlöschung der Zweckbindung (z.B. Austritt eines Vereinsmitglieds) auch die Pflicht zur Löschung der Daten. Allerdings können der Löschung vertragliche Vereinbarungen und Satzungen entgegenstehen (§35 BDSG). Zudem kann eine gesetzliche Pflicht zur längeren Aufhebung bestehen, z.B. Dokumente, die für die Steuer relevant sind (10 Jahre, §257 HGB), und Sozialdaten (10 Jahre, §304 SGB). Bei einem Mitgliedsaustritt müssen deshalb Name, Anschrift, Daten zur Mitgliedschaft im Verein und Daten zur Beitragszahlung über 10 Jahre aufgehoben werden. Ansonsten gilt grundsätzlich die Frist zur Löschung nach drei Jahren.",
...
Da der **Datenschutz in anderen Ländern** (z.B. in den USA) nicht so ausgeprägt ist wie in der EU, sollten wir bei der Auswahl von datenverarbeitenden Tools darauf achten, wo diese ihren Hauptsitz und Server haben. Möglicherweise müssen wir dann zusätzliche Maßnahmen zum Schutz der Daten ergreifen (z.B. rechtliche Vereinbarung, Passwortschutz, Verschlüsselung).
Seid Ihr in einer Firma, einer Organisation oder einem Verein tätig, veröffentlicht Ihr am besten auf Eurer Webseite eine **Datenschutzerklärung sowie Kontaktdaten von Ansprechpartner:innen**. Innerhalb Eurer Organsiation legt ihr am besten zusätzlich ein **Verarbeitungsverzeichnis und Datenschutzmanagementsystem** an, welches Ihr in festen Abständen regelmäßig überprüft. Wichtig hierbei: Bestimmt zur Einhaltung und Überprüfung einer eigenen Richtlinien verantwortliche Personen innherlab Eurer Strukturen, das ist für Euch, aber auch für externe Personen, mit denen Ihr zusammenarbeitet eine große Stütze. Eine vollständige Datenschutzerklärung enthält idealerweise folgende Dinge:
...
Neben dem Datenschutz solltet Ihr Euch auch mit den **ethischen Anforderungen** Eurer Daten beschäftigen. Denn nur weil etwas augenscheinlich legal ist, bedeutet das nicht, dass es auch moralisch vertretbar ist. Als Inspiration kann Euch hierbei die [**Charta der digitalen Grundrechte**] (https://digitalcharta.eu/) dienen.

Auf Basis dieser Überlegungen, könnt Ihr **übeprüfen**, ob Eure Datengrundlage ausreicht, um Sachverhalte **sinnvoll zu bewerten**. Außerdem könnt Ihr Eure zugrundeliegenden Daten **evaluieren** und gezielt nach **Verzerrungen** (= engl. Biases) suchen. Anschließend solltet Ihr Euch darüber Gedanken machen, ob Eure Daten und deren Analyse zur **strukturellen Benachteiligung, Diskriminierung oder (negativen) Politisierung** von Menschen führen kann. Kommen im Zuge dieser Überlegungen Zweifel auf, müssen wir diese Ernst nehmen und ggf. unsere Erhebungs- und Analyseinstrumente **überarbeiten**.
Wichtig: Denkt v.a. bei der Programmierung von Algorithmen stets darüber nach, ob die zu treffende Entscheidung überhaupt **maschinell** anhand von sozio-demographischen Merkmalen und deren Proxies getroffen werden sollte. Das gilt insbesondere bei Algorithmen, die über **Zugang zu essentiellen Bereichen** wie dem Arbeits- und Finanzmarkt oder auch über den Zugang zu zivilgesellschaftlichen Programmmen entscheiden!
...
quiz(caption = NULL,
  question("Wie könnt Ihr Daten zu Geschlecht und Aussehen sensibel erheben?",
      ...
      answer("Mit Selbstidentifikation anhand Kombination aus einigen Vorschlägen, Opt Out (die Möglichkeit die Frage unbeantwortet zu lassen) und Freitextfeld."),
      answer("Mit Selbstidentifikation anhand einer Kombination aus einigen Vorschlägen, Opt Out, Freitextfeld und Fremdidentifikation (d.h. wie andere Menschen die Befragungsperson wahrnehmen würden).", correct = TRUE),
      correct = "Richtig, Geschlechteridentitäten sind zunehmend diversund das ist gut so! Wenn wir das Geschlecht einer Person im Rahmen unserer Datenerhebung abfragen wollen, versuchen wir daher, niemanden auszugrenzen oder zu verletzen. Dafür verwenden wir vielfältige Frageformate und distanzieren uns von den gängigen Merkmalsausprägungen (ausschließlich 'männlich' vs. 'weiblich').",
...
Die **Stiftung Datenschutz** kennen wir ja bereits! Diese haben, wie wir finden, eine ziemlich hilfreiche **Vorlage für Vereine und gemeinnützige Organisationen** veröffentlicht. Dieses Muster wollen wir mit Euch teilen - Ihr könnt es [hier](https://github.com/CorrelAid/lernplattform/blob/main/abbildungen/02_datenschutz-und-datenethik/Vorlage_Datenverarbeitungstätigkeiten.xlsx?raw=true){target="_blank"} herunterladen.

<center>
![*Template: Datenverarbeitungsverzeichnis*](https://github.com/CorrelAid/lernplattform/blob/main/abbildungen/02_datenschutz-und-datenethik/Vorlage_Datenverarbeitung_NGO.png?raw=true){#id .class width=100% height=100%}
</center>
<br>
