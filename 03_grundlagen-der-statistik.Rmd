...
<p>
<center>
![**Abbildung**: Zyklisches Modell des Prozesses der Wertschöpfung aus Daten. Quelle: Schüller, Busch, Hindinger (2019)](https://github.com/CorrelAid/rlernen_umwelt/blob/main/abbildungen/03_grundlagen-der-statistik/Zyklisches_Modell.png?raw=true){#id .class width=70% height=70%}
</center>
</p>
...
<p>
<center>
![*Quelle: <https://www.destatis.de/DE/Presse/Pressemitteilungen/2023/11/PD23_N062_32.html> (Grafik 1)*](https://github.com/CorrelAid/rlernen_umwelt/blob/main/abbildungen/03_grundlagen-der-statistik/umweltschutzinvestitionen-klimaschutz.png?raw=true){#id .class width=100%}
</center>
</p>
...
quiz(caption = "Fragen zur Pressemitteilung",
  question("Wie haben sich die Investitonen in Maßnahmen zur Nutzung erneuerbarer Energien von 2011 bis 2021 entwickelt?",
    ...
    answer("Sie haben sich zwischen 2011 und 2021 insgesamt erhöht, jedoch nicht kontinuierlich.", correct = TRUE),
    answer("Sie haben sich zwischen 2011 und 2021 insgesamt reduziert."),
...
<p>
<center>
![*Quelle: <https://www.destatis.de/DE/Presse/Pressemitteilungen/2021/07/PD21_N045_639.html> (Grafik 2)*](https://github.com/CorrelAid/rlernen_umwelt/blob/main/abbildungen/03_grundlagen-der-statistik/verbraucherinnenpreise_pkw.png?raw=true){#id .class width=100%}
</center>
</p>

<p>
<center>
![*Quelle: <https://www.destatis.de/DE/Presse/Pressemitteilungen/2021/07/PD21_N045_639.html> (Grafik 3)*](https://github.com/CorrelAid/main/blob/jonas_überarbeitung/abbildungen/03_grundlagen-der-statistik/verbraucherinnenpreise_bahn.png?raw=true){#id .class width=100%}
</center>
</p>
...
<p>
<center>
![**Abbildung**: Grundbegriffe für den Umgang mit tabellarischen Datensätzen. Quelle: Eigene Darstellung.](https://github.com/CorrelAid/rlernen_umwelt/blob/main/abbildungen/03_grundlagen-der-statistik/Datensatz.png?raw=true){#id .class width=100%}
</center>
</p>
...
<p>
<center>
![**Abbildung**: Numerische Datentypen. Quelle: \@allison_horst, lizensiert nach cc by 4.0](https://github.com/CorrelAid/rlernen_umwelt/blob/main/abbildungen/03_grundlagen-der-statistik/AllisonHorst_Datentypen2.png?raw=true){#id .class width=100%}
</center>
</p>
...
<p>
<center>
![**Abbildung**: Kategorische Datentypen. Quelle: \@allison_horst, lizensiert nach cc by 4.0](https://github.com/CorrelAid/rlernen_umwelt/blob/main/abbildungen/03_grundlagen-der-statistik/AllisonHorst_Datentypen1.png?raw=true){#id .class width=100%}
</center>
</p>
...
question("Welches Skalenniveau erlaubt es, den Abstand zwischen den Werten zu messen, hat jedoch keinen natürlichen Nullpunkt?",
    ...
    correct = "Richtig. Nominalskalierte Werte dürfen wir ausschließlich in Kategorien einteilen. Somit können wir lediglich Unterschiede zwischen den Variablen feststellen. Aussagen über eine Rangordung oder die Bedeutung der Unterschiede dürfen wir allerdings nicht treffen. Das dürfen wir bei Ordinalskalen, allerdings ist der Abstand hier nicht interpretierbar. Ratioskalen haben wiederum einen natürlichen Nullpunkt.",
    incorrect = "Leider falsch. Schau' noch einmal weiter oben nach: bei nominalskalierten Werten, dürfen wir diese lediglich in Kategorien einteilen. Somit können wir zwar feststellen, dass es Unterschiede zwischen den Variablen gibt. Aussagen über eine Rangordung oder die Bedeutung der Unterschiede dürfen wir allerdings nicht treffen.",
    allow_retry = TRUE,
    try_again_button = "Nochmal versuchen"
    ),
...
<p>
<center>
![**Abbildung**: Schiefe vs. symmetrische Verteilungen. Quelle: Eigene Darstellung](https://github.com/CorrelAid/rlernen_umwelt/blob/main/abbildungen/03_grundlagen-der-statistik/Schiefe_Verteilungen.png?raw=true){#id .class width=100%}
</center>
</p>
...
Streuungsparameter beschreiben das Ausmaß der **Streuung der Daten**. Diese versuchen zusätzliche Kennziffern für die
...
<p>
<center>
![**Abbildung**: Bestimmung und Bedeutung von p-Quantilen. Quelle: Eigene Darstellung](https://github.com/CorrelAid/rlernen_umwelt/blob/main/abbildungen/03_grundlagen-der-statistik/Quantile.png?raw=true){#id .class width=100%}
</center>
</p>
...
![Boxplot mit statistischen Kennzahlen](https://github.com/CorrelAid/rlernen_umwelt/blob/main/abbildungen/03_grundlagen-der-statistik/Boxplot_Stat.png?raw=true){#id .class width="100%" height="100%"}
