...
Die Korrelation kann zur Interpretation der Daten sehr hilfreich, aber auch sehr trügerisch sein. 
...
- Wechselt nun zur Darstellung 'Säulendiagramme' und bleibt im Jahr 2016. Betrachtet wiederum die einzelnen Sektoren: Welche Länder stechen jeweils positiv und negativ heraus und wie sieht es mit Blick auf die gesamte EU aus - werden die Ziele für den Brutto-Energieverbrauch von den meisten Ländern erreicht oder nicht? Tipp: Oben rechts könnt Ihr auf 'Daten ordnen' klicken - das macht diese Darstellung übersichtlicher.
