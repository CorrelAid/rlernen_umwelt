...
-> Grafik: Numerische Datentypen und Quiz zu Datentypen
...
- Startet mit den Zeitreihen für den Brutto-Energieverbrauch, betrachten wir die Länder Deutschland, Schweden und Österreich. Wie entwickelt sich die Nutzung der erneuerbaren Energien in diesen Ländern? Was sind Gemeinsamkeiten in der Entwicklung und wo gibt es Unterschiede? Was fällt beim Blick auf die EU-Ziele für 2020 und 2030 auf - werden diese erreicht oder nicht? sucht euch drei Länder aus und vergleicht die Ausgaben in 'absoluten' Werten, 'in % BIP' und 'pro Kopf'. Was verändert sich? Warum?
- Werfen wir anschließend einen Blick auf die Zeitreihen für den Verkehrs- und Elektrizitätssektor. Was fällt hier auf? Wie verlaufen die Entwicklungen in den einzelnen Ländern und wie lässt sich der internationale Vergleich beschreiben - wie sieht die Entwicklung in Deutschland im internationalen Vergleich aus?
