...
-> ![**Abbildung:** Zyklisches Modell des Prozesses der Wertschöpfung aus Daten. Quelle: Schüller, Busch, Hindinger (2019)](https://github.com/CorrelAid/lernplattform/blob/main/abbildungen/08_grundlagen-der-statistik/Zyklisches_Modell.png?raw=true){#id .class width=100% height=100%} 
...
-> Grafik: "Stichprobe und Population"
...
![**Abbildung:** Grundbegriffe für den Umgang mit tabellarischen Datensätzen. Quelle: Eigene Darstellung.](abbildungen/08_grundlagen-der-statistik/Datensatz.png?raw=true){#id .class width=100% height=100%} 
